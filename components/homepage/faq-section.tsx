  ...
  return (
    <div className='flex' style={{ minHeight: '600px' }}>
      <div className='flex flex-[0.4] justify-center items-center' style={{ height: '600px', minHeight: '600px' }}>
        <img src="../../src/assets/homepage/genie.png" alt="FAQ 1" className="w-auto h-[80%] z-20" style={{ maxHeight: '480px', height: '80%', objectFit: 'contain' }} />
      </div>
      <div className='col-span-4 space-y-6 flex flex-col flex-[0.6] pr-10 z-20'>
